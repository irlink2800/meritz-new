...
public abstract class MmsRequest {
    ...
    // MMS callback
    protected onSendCallback mCallback;

    public interface onSendCallback {
        public void onSendResult(int code, Intent intent);
    }
    ...
    public MmsRequest(RequestManager requestManager, int subId, String creator,
            Bundle configOverrides, onSendCallback callback) {
...
//                        // Retry
    ...
    public void processResult(Context context, int result, byte[] response, int httpStatusCode) {
        ...
        if (pendingIntent != null) {
            ...
            if(mCallback != null) mCallback.onSendResult(result, fillIn);
        }
