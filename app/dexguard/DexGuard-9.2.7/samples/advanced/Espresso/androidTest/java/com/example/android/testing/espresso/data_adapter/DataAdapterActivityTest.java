...
package com.example.android.testing.espresso.data_adapter;
...
/**
 * Tests to verify that the behavior of {@link DataAdapterActivity} is correct.
 * <p>
...
@LargeTest
public class DataAdapterActivityTest {
     ...
     */
    @Rule
    public ActivityTestRule<DataAdapterActivity> mActivityRule = new ActivityTestRule<>(
            DataAdapterActivity.class);
    ...
    private static DataInteraction onRow(String str) {
        return onData(hasEntry(equalTo(DataAdapterActivity.ROW_TEXT), is(str)));
    }
}
